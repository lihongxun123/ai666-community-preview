document.addEventListener("DOMContentLoaded", () => {
  ...
  const works = [
    { id: "S-001", title: "光之门", author: "空镜", track: "short", heat: 9840, score: 89.8, cover: "assets/competition/featured-light-library.png", description: "旅人穿过无尽书库，向光照进来的门扉前行。", createdAt: 9 },
    { id: "S-002", title: "最后的守望", author: "阿青", track: "medium", heat: 8920, score: 91.4, cover: "assets/competition/featured-ancient-tree.png", description: "古树与守望者共同等待一场迟来的春天。", createdAt: 8 },
    { id: "S-003", title: "云上有声", author: "司南", track: "free", heat: 8560, score: 87.6, cover: "assets/competition/featured-sky-whale-city.png", description: "鲸形飞行器越过城市上空，留下被人听见的回声。", createdAt: 7 },
    { id: "S-004", title: "人间有味", author: "小野", track: "short", heat: 7910, score: 85.3, cover: "assets/image_assets/7.png", description: "从一顿晚饭看见人与城市之间的温度。", createdAt: 6 },
    { id: "S-005", title: "月面来信", author: "七号", track: "medium", heat: 7420, score: 83.9, cover: "assets/image_assets/9.png", description: "一封跨越月海寄回地球的影像来信。", createdAt: 5 },
    { id: "S-006", title: "不会熄灭的灯", author: "灵感罐头", track: "free", heat: 7080, score: 82.1, cover: "assets/image_assets/11.png", description: "一盏灯在废墟中替所有人保存回家的方向。", createdAt: 4 },
    { id: "S-007", title: "潮汐之后", author: "北岛", track: "long", heat: 6760, score: 80.7, cover: "assets/image_assets/12.png", description: "潮汐退去后，一座城市重新学习与海洋相处。", createdAt: 3 },
    { id: "S-008", title: "像素花园", author: "夏川", track: "short", heat: 6320, score: 79.5, cover: "assets/image_assets/13.png", description: "程序员为旧机器种下一座会呼吸的像素花园。", createdAt: 2 },
    { id: "S-009", title: "末班列车", author: "一零", track: "medium", heat: 5980, score: 77.8, cover: "assets/image_assets/14.png", description: "末班列车穿过无人站台，载着最后一批记忆离开。", createdAt: 1 },
    { id: "S-010", title: "雨停之前", author: "林渡", track: "short", heat: 5710, score: 78.6, cover: "assets/image_assets/4.png", description: "雨停前的三十秒里，城市悄悄交换了颜色。", createdAt: 10 },
    { id: "S-011", title: "纸上星河", author: "向晚", track: "short", heat: 5380, score: 77.4, cover: "assets/image_assets/5.png", description: "纸张折叠成星河，又在掌心缓缓展开。", createdAt: 11 },
    { id: "S-012", title: "风的切片", author: "鹿游", track: "short", heat: 5010, score: 75.8, cover: "assets/image_assets/15.jpg", description: "把看不见的风切成可以收藏的影像。", createdAt: 12 },
    { id: "S-013", title: "深海回信", author: "暮蓝", track: "medium", heat: 5540, score: 81.2, cover: "assets/image_assets/16.png", description: "来自深海站点的回信，记录一场迟到的重逢。", createdAt: 13 },
    { id: "S-014", title: "给明天的你", author: "松子", track: "medium", heat: 5210, score: 79.9, cover: "assets/image_assets/17.png", description: "今天的人把一段普通生活寄给明天。", createdAt: 14 },
    { id: "S-015", title: "零点广播", author: "迟野", track: "medium", heat: 4860, score: 76.8, cover: "assets/image_assets/18.png", description: "零点之后，广播开始播放城市遗失的声音。", createdAt: 15 },
    { id: "S-016", title: "群岛纪事", author: "闻舟", track: "long", heat: 6420, score: 88.6, cover: "assets/image_assets/19.png", description: "一群人在漂移群岛上重新建立彼此的联系。", createdAt: 16 },
    { id: "S-017", title: "记忆修复局", author: "南枝", track: "long", heat: 6090, score: 85.4, cover: "assets/image_assets/20.png", description: "修复师进入陌生人的记忆，寻找缺失的一天。", createdAt: 17 },
    { id: "S-018", title: "迁徙者", author: "原野", track: "long", heat: 5520, score: 82.3, cover: "assets/image_assets/21.png", description: "当城市开始迁徙，人们决定带走哪些共同记忆。", createdAt: 18 },
    { id: "S-019", title: "第七码头", author: "江临", track: "long", heat: 5070, score: 79.7, cover: "assets/image_assets/7.png", description: "第七码头每晚只迎接一艘不存在的船。", createdAt: 19 },
    { id: "S-020", title: "静默之城", author: "周末", track: "long", heat: 4690, score: 76.4, cover: "assets/image_assets/9.png", description: "失去声音的城市，用光重新学会交流。", createdAt: 20 },
    { id: "S-021", title: "梦的博物馆", author: "微尘", track: "free", heat: 6540, score: 86.2, cover: "assets/image_assets/11.png", description: "每件展品都保存着一段没有完成的梦。", createdAt: 21 },
    { id: "S-022", title: "倒生花", author: "秋辞", track: "free", heat: 6170, score: 83.5, cover: "assets/image_assets/12.png", description: "花朵倒着生长，带人回到选择发生之前。", createdAt: 22 },
    { id: "S-023", title: "无重力午后", author: "青禾", track: "free", heat: 5660, score: 80.6, cover: "assets/image_assets/13.png", description: "普通午后忽然失去重力，人们重新认识日常。", createdAt: 23 },
    { id: "S-024", title: "另一个天气", author: "小满", track: "free", heat: 5230, score: 78.2, cover: "assets/image_assets/14.png", description: "一台旧机器每天生成一种不存在的天气。", createdAt: 24 },
  ];
  ...
  const carriedKeys = [...Object.keys(defaults), "claim", "submission_id", "utm_source", "utm_medium", "utm_campaign", "utm_content"];
  ...
  const updateCompetitionLinks = () => {
    document.querySelectorAll("a[data-competition-link]").forEach((link) => {
      ...
      if (link.dataset.submissionId) overrides.submission_id = link.dataset.submissionId;
      ...
      if (targetUrl.pathname.endsWith("/competition-works.html") && !link.dataset.submissionId) {
    ...
    confirm?.addEventListener("click", () => {
      ...
      window.setTimeout(() => {
        ...
        if (registrationOutcome === "duplicate") {
          ...
          updateUrl({ registration: "registered" });
          closeModal(modal);
          renderHome();
          showToast("你已完成报名，无需重复报名", "warning");
  ...
  const createWorkCard = (work) => {
    const link = buildHref("./competition-work.html", { submission_id: work.id, track: work.track, work: "public" });
    return `<a class="competition-work-card" href="${link}" data-work-card data-competition-work-open data-competition-link data-submission-id="${work.id}" data-track="${work.track}" data-author="${work.author}" data-work-state="public">
  ...
  const initWorks = () => {
    ...
    document.querySelector("[data-works-list]")?.addEventListener("click", (event) => {
      ...
      event.preventDefault();
      openWorkDetail(card.dataset.submissionId, { trigger: card });
    });
    renderWorks();
  };
    ...
    if (view && edit) {
      const submissionActions = {
        draft: state.phase === "collecting"
          ? { label: "继续投稿", href: edit.href, primary: true, removable: true }
        ...
        "v2-edit": { label: "查看作品", href: view.href, editable: actionState.submit }
      };
      const cardAction = submissionActions[state.submission] || submissionActions.public;
  ...
  let uploads = { edited: null, original: null };
  let formDirty = false;
  ...
  const maxDurationForTrack = (track) => ({ short: 30, medium: 90, long: Infinity, free: Infinity }[track] || Infinity);
  const minDurationForTrack = (track) => ({ short: 8, medium: 30, long: 90, free: 0 }[track] || 0);
  const validateFile = async (file, type) => {
    if (!file) return;
    const validType = ["video/mp4", "video/quicktime"].includes(file.type) || /\.(mp4|mov)$/i.test(file.name);
    if (!validType) { setUploadState(type, "error", "格式不支持，请上传 MP4 或 MOV"); return; }
    if (file.size > 500 * 1024 * 1024) { setUploadState(type, "error", "文件超过 500MB，请压缩后重试"); return; }
    if (file.name.toLowerCase().includes("network-fail")) { setUploadState(type, "error", "上传失败，请检查网络后重试"); return; }
    if (file.name.toLowerCase().includes("duration-fail")) {
      setUploadState(type, "error", `视频时长需符合 ${tracks[state.track].label} 赛道`);
      return;
    }
    setUploadState(type, "uploading", "上传中…");
    window.setTimeout(() => setUploadState(type, "ready", file.name), 520);
  };
  ...
  const renderSubmit = () => {
    ...
    if (state.submission === "new") {
      ...
      setUploadState("edited", "idle", "MP4 / MOV · 不超过 500MB");
      setUploadState("original", "idle", "上传 AI 生成原始视频");
    } else if (state.submission === "draft") {
      if (inputTitle && !inputTitle.value) inputTitle.value = "未完成的光影实验";
    } else if (!uploads.edited) {
      setUploadState("edited", "ready", "light-door-final.mp4");
      setUploadState("original", "ready", "light-door-source.mp4");
    }
  ...
  const initSubmit = () => {
    ...
    if (!embeddedSubmit) {
      ...
      closeLink.href = buildHref("./competition-detail.html", { submission_id: null });
    ...
    document.querySelectorAll("[data-upload-input]").forEach((input) => input.addEventListener("change", () => {
      formDirty = true;
      validateFile(input.files?.[0], input.dataset.uploadInput);
    }));
    ...
    document.querySelector("[data-submit-confirm], [data-competition-submit]")?.addEventListener("click", () => {
      ...
      if (!uploads.edited) { setInlineMessage(message, "请上传后期成片", "error"); document.querySelector('[data-upload-slot="edited"]')?.focus(); return; }
      if (state.integration !== "connected" && !uploads.original) { setInlineMessage(message, "请上传生成原片", "error"); return; }
      ...
      setInlineMessage(message, "正在提交作品与来源材料，请稍候", "processing");
      window.setTimeout(() => {
  ...
  const resolveWorkBySubmissionId = (submissionId) => works.find((item) => item.id === submissionId) || null;
  const selectedWork = () => resolveWorkBySubmissionId(new URLSearchParams(window.location.search).get("submission_id") || "S-001");
  const workCanonicalHref = (work) => {
    const url = new URL("./competition-work.html", window.location.href);
    url.searchParams.set("submission_id", work.id);
  ...
  const workDetailMarkup = (work, surface) => {
    const submissionId = escapeWorkMarkup(work.id);
    ...
    const trackRank = [...works].filter((item) => item.track === work.track).sort((a, b) => b.heat - a.heat).findIndex((item) => item.id === work.id) + 1;
    ...
    return `<article class="case-detail-dialog competition-work-detail-dialog" data-work-submission-id="${submissionId}" data-detail-surface="${surface}" ${isModal ? 'role="dialog" aria-modal="true"' : 'role="article"'} aria-labelledby="${tabName}-title">
      ...
      <aside class="case-detail-aside">
        ...
        <div class="detail-tags"><span>视频作品</span><span data-work-track-label>${trackLabel}</span><span>AI 生成与后期制作</span></div>
  ...
  const bindWorkDetailSurface = (root, work, surface) => {
    ...
    root.querySelector("[data-comment-submit]")?.addEventListener("click", (event) => {
      ...
      window.setTimeout(() => {
        ...
        setInlineMessage(message, "评论已发表", "success");
      }, 520);
    });
  ...
  function renderWorkDetailInto(root, work, surface = "page") {
    ...
    root.dataset.renderedSubmissionId = work.id;
    ...
    if (source) {
      const copy = state.integration === "connected" ? ["创作来源已确认", "作品保留可查看的创作过程摘要。", "查看创作过程"] : state.integration === "invalid" ? ["创作来源暂不可用", "部分公开材料当前无法打开。", ""] : ["AI 生成与后期制作", "创作者已提交生成原片和最终成片。", ""];
  ...
  const openWorkDetail = (submissionId, { pushHistory = true, trigger = null } = {}) => {
    if (page.dataset.page !== "competition-works") return;
    ...
    const work = resolveWorkBySubmissionId(submissionId);
  ...
  const syncWorkDetailWithHistory = () => {
    ...
    if (submissionId) openWorkDetail(submissionId, { pushHistory: false });
    else hideWorkDetail();
  };
  ...
  const initWorkDetail = () => {
    ...
    if (page.dataset.page === "competition-work") {
      ...
      document.querySelector("[data-competition-work-page-close]")?.addEventListener("click", () => {
        ...
        else window.location.href = buildHref("./competition-works.html", { submission_id: null, work: "public" });
      });
    }
  ...
  Object.keys(trackRanking).forEach((track, trackIndex) => {
    const additions = supplementalRankSeeds.map(([title, author], index) => {
      const rank = index + 7;
      const id = `S-R${trackIndex + 1}-${String(rank).padStart(2, "0")}`;
      const safeCoverIndex = [1, 2, 3, 4, 5, 7, 9, 11, 12, 13, 14, 16, 17, 18, 19, 20, 21][index % 17];
      works.push({ id, title, author, track, heat: 4380 - index * 170 - trackIndex * 30, score: 74.8 - index * 1.15 - trackIndex * .1, cover: `assets/image_assets/${safeCoverIndex}.png`, description: `${title}以影像记录一段被忽略的时间与情绪。`, createdAt: 40 - index });
      return [id, 4380 - index * 170 - trackIndex * 30, 74.8 - index * 1.15 - trackIndex * .1];
    });
    trackRanking[track].push(...additions);
  });
  const rankRows = () => trackRanking[state.track].map(([id, heat, result], index) => ({ rank: index + 1, work: works.find((item) => item.id === id) || works[index], heat, result }));
  const boardMeta = {
  ...
  const claimModel = {
    publicity: { title: "结果公示中", note: "公示至 2026.09.23 10:00。公示结束且结果无调整后，再确认领奖信息。", action: "公示结束后开放", disabled: true },
    "claim-required": { title: "请确认领奖信息", note: "请确认获奖账号、公开署名和领取意愿。提交后由赛事方人工核验资格。", action: "确认领奖信息" },
    verification: { title: "资格核验中", note: "赛事方正在人工核验参赛资格与领奖信息；结果将通过站内信通知。", action: "等待核验", disabled: true },
    "pending-delivery": { title: "待发放", note: "资格核验已通过。赛事方将人工完成权益发放并更新记录。", action: "查看发放状态" },
    completed: { title: "已发放", note: "赛事方已完成权益发放并记录结果；如有问题请联系赛事助手。", action: "查看发放记录" },
    "appeal-pending": { title: "异议处理中", note: "已提交结果异议。处理期间领奖与发放暂停，赛事助手将通过站内信回复。", action: "查看处理进度" },
  };
  const renderResultClosure = (availability) => {
    ...
    const claimPanel = document.querySelector("[data-competition-prize-claim]");
    if (!claimPanel) return;
    const ownWinner = rankRows().slice(0, 3).find((row) => row.work.author === "空镜");
    claimPanel.hidden = !resultPublished || state.auth !== "user" || !ownWinner;
    if (claimPanel.hidden) return;
    const copy = claimModel[claimState] || claimModel.publicity;
    claimPanel.dataset.claimState = claimState;
    claimPanel.querySelector("[data-claim-title]").textContent = copy.title;
    claimPanel.querySelector("[data-claim-note]").textContent = copy.note;
    const awardNames = ["冠军", "亚军", "季军"];
    claimPanel.querySelector("[data-claim-award]").textContent = `${tracks[state.track].label.split(" · ")[0]} 赛道${awardNames[ownWinner.rank - 1]}`;
    claimPanel.querySelector("[data-claim-rank]").textContent = String(ownWinner.rank).padStart(2, "0");
    claimPanel.querySelector("[data-claim-cover]").src = ownWinner.work.cover;
    claimPanel.querySelector("[data-claim-cover]").alt = `我的获奖作品《${ownWinner.work.title}》`;
    claimPanel.querySelector("[data-claim-work-title]").textContent = ownWinner.work.title;
    claimPanel.querySelector("[data-claim-score]").textContent = ownWinner.result.toFixed(1);
    const action = claimPanel.querySelector("[data-claim-action]");
    action.textContent = copy.action;
    action.disabled = Boolean(copy.disabled);
  };
  ...
  const renderRanking = () => {
    ...
    podium.innerHTML = rows.slice(0, 3).map((row) => {
      const href = buildHref("./competition-work.html", { submission_id: row.work.id, track: state.track, work: "public" });
      const badge = isPublishedResult ? awardNames[row.rank - 1] : String(row.rank).padStart(2, "0");
      return `<a class="competition-podium-card rank-${row.rank} ${row.rank === 1 ? "is-first" : ""}" href="${href}" data-competition-link data-submission-id="${row.work.id}" data-track="${state.track}"><div class="competition-podium-work-media"><img src="${row.work.cover}" alt="作品《${row.work.title}》"><b class="${isPublishedResult ? "is-award" : ""}">${badge}</b><div class="competition-podium-work-copy"><div><h3>${row.work.title}</h3><p><img class="competition-podium-author-avatar" src="${authorAvatarOf(row.work)}" alt=""><span>${row.work.author}</span></p></div><strong>${valueOf(row)}<small>${meta.unit}</small></strong></div></div></a>`;
    }).join("");
    ...
    list.innerHTML = rows.slice(3).map((row) => {
      ...
      return `<a class="competition-rank-row${isMine ? " is-mine" : ""}" href="${href}" data-competition-link data-submission-id="${row.work.id}" data-track="${state.track}"><b>${String(row.rank).padStart(2, "0")}</b><img src="${row.work.cover}" alt="作品《${row.work.title}》"><span class="rank-work"><span class="rank-title">${row.work.title}${isMine ? '<em class="competition-rank-own">我的作品</em>' : ""}</span><small>创作者 · ${row.work.author}</small></span><span class="rank-track">${tracks[state.track].label}</span><strong class="competition-heat">${valueOf(row)} <small>${meta.unit}</small></strong></a>`;
    }).join("");
    updateCompetitionLinks();
  };
  ...
  const initRulesNavigation = () => {
    ...
    const nav = document.querySelector(".competition-rules-nav");
    if (!nav) return;
